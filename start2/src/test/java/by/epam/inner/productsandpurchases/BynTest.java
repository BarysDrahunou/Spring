...
public class BynTest {
    ...
    @Test
    public void multiplicationWithDouble() {
        Byn result1 = byn1.multiplicationWithDouble(9.50);
        Byn result2 = byn4.multiplicationWithDouble(4.33);
        assertEquals(result1, new Byn(950));
        assertEquals(result2, new Byn("53.91"));
    }

    @Test
    public void testToString() {
        assertEquals(byn1.toString(),"1.00");
        assertEquals(byn2.toString(),"0.00");
        assertEquals(byn3.toString(),"1.00");
        assertEquals(byn4.toString(),"12.45");
    }
